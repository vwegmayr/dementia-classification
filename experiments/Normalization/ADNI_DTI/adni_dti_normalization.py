...
class Normalize():
    ...
    def __init__(self, mode):
        self.mode = mode
        self.mean_path = paths['norm_mean_var'] + self.mode+'_train_data_mean.pkl'
        self.var_path = paths['norm_mean_var'] + self.mode+'_train_data_var.pkl'
        self.mean_norm = []
        self.var_norm = []
...
def main():
    norm_object = Normalize('adni_dti')
