...
class MultiLayerPerceptron:
    ...
    def __init__(self, params):
        ...
        self.num_features = self.param['num_feat']
    ...
    def inference(self, images, keep_prob, is_training):
        ...
        with tf.variable_scope('fullcn1') as scope:
        ...
        with tf.variable_scope('fullcn2') as scope:
            ...
            biases = self.variable_on_cpu(name="biases",
                                          ...
                                          initializer=tf.constant_initializer(
                                              0.1))
            pre_activation2 = tf.matmul(fullcn_drop, weights) + biases
            fullcn_2 = tf.nn.relu(pre_activation2, name=scope.name)
            fullcn_2_drop = tf.nn.dropout(fullcn_2, keep_prob)
        ...
        with tf.variable_scope('logits') as scope:
            ...
            biases = self.variable_on_cpu(name='biases',
                                          ...
                                          initializer=tf.constant_initializer(
                                              0.1))
            logits = tf.add(tf.matmul(fullcn_2_drop, weights), biases,
                            name=scope.name)
