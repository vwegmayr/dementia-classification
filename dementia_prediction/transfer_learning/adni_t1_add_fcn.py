...
class CNN:
    ...
    def fcn_nw(self, transfer_input, keep_prob, is_training):
        with tf.variable_scope('fullcn3') as scope:
            ...
            biases = self.variable_on_cpu(name="biases",
                                          ...
                                          initializer=tf.constant_initializer(
                                              0.1))
            pre_activation2 = tf.matmul(transfer_input, weights) + biases
    ...
    def get_features(self, image_data):
        with tf.Graph().as_default() as model_graph:
            ...
            if ckpt and ckpt.model_checkpoint_path:
                ...
                layer = model_graph.get_tensor_by_name('Train/fullcn2/fullcn2:0')
    ...
    def evaluation(self, sess, eval_op, dataset, images, transfer_input, labels,
